            ...
            <ul className="space-y-2 font-medium">
              ...
              <li>
                ...
                >
                  ...
                  <span className="flex-1 ms-3 whitespace-nowrap">AI Assistance</span>
                </Link>
              </li>
              <li>
                <button  onClick={handleLogout} class="flex-1  p-2  ms-3v text-white  whitespace-nowrap dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">Sign Out</button>    
              </li>
            </ul>
          </div>
        </aside>
